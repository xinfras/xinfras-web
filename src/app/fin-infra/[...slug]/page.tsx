...
async function getContent(slug: string[]) {
  try {
    ...
    return await fetchDocContent("fin-infra", docPath);
  } catch {
    return null;
  }
}

export default async function FinInfraDocPage({ params }: PageProps) {
  ...
  const githubUrl = getGithubUrl("fin-infra", slug.join("/"));
