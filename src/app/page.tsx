    ...
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          ...
          <div className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28 md:py-36 lg:py-44">
            <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 text-center">
              <Badge variant="outline" className="rounded-full border-primary/30 bg-primary/5 px-4 py-1.5 text-sm font-medium backdrop-blur-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-4 w-full sm:w-auto">
                <Button size="default" className="w-full sm:w-auto h-10 px-6 text-sm font-medium shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all" asChild>
                  <Link href="/docs">
                    Get Started
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
            {frameworks.map((framework) => (
              <Link key={framework.name} href={framework.href} className="block">
                <Card className="group relative h-full overflow-hidden transition-all duration-500 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-2 border-border/50 hover:border-primary/30 bg-card/50 backdrop-blur-sm">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <CardHeader className="relative pb-2">
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-background/80 backdrop-blur-sm p-3 shadow-lg ring-1 ring-border/50 group-hover:ring-primary/30 group-hover:ring-2 transition-all text-primary">
                  ...
                  <CardContent className="relative pt-2">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      {framework.features.map((feature) => (
                        <Badge key={feature} variant="secondary" className="text-xs bg-background/60 backdrop-blur-sm">
                          {feature}
                        </Badge>
                      ))}
                    </div>
        ...
        <section className="relative border-y border-border/40 bg-muted/30">
          ...
          <div className="mx-auto relative w-full max-w-screen-xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28">
        ...
        <section className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28">
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={feature.title}
                className="group rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm p-5 sm:p-6 transition-all hover:border-border hover:bg-card/50 hover:shadow-lg"
              >
        ...
        {/* CTA Section */}
        <section className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28">
          <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-primary/10 via-primary/5 to-primary/10 px-6 sm:px-12 md:px-20 py-12 sm:py-16 md:py-20 text-center backdrop-blur-sm">
            ...
            <div className="absolute right-0 bottom-0 translate-x-1/4 translate-y-1/4">
              <div className="h-[200px] w-[400px] rounded-full bg-primary/15 blur-[100px]" />
            </div>
            ...
            <div className="relative">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                <Button size="default" className="w-full sm:w-auto h-10 px-6 text-sm font-medium shadow-lg shadow-primary/25" asChild>
                  <Link href="/docs">
                    Start Building
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
