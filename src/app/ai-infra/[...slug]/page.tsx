...
async function getContent(slug: string[]) {
  try {
    ...
    return await fetchDocContent("ai-infra", docPath);
  } catch {
    return null;
  }
}

export default async function AIInfraDocPage({ params }: PageProps) {
  ...
  const githubUrl = getGithubUrl("ai-infra", slug.join("/"));
